#To illustrate different pipeline stages
import numpy as np
import cv2
...
from line_fit import line_fit, vis2, calc_curve, final_vis
...
for image_file in image_files:
    ...
    vis2(img, ret, save_file=save_file)
    ...
    img = final_vis(undist, left_fit, right_fit, m_inv, left_curve, right_curve, vehicle_offset)
    plt.imshow(img)
