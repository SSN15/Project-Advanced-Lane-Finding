...
def vis1(binary_warped, ret, save_file=None):
    """
...
def vis2(binary_warped, ret, save_file=None):
    """
...
def final_vis(undist, left_fit, right_fit, m_inv, left_curve, right_curve, vehicle_offset):
    """
